...
echo "<h1 id='coursetitle'>Course Calendar for " . $title .  "</h1>";
...
echo "<table  summary='Listing of lessons and due dates of assignments.' width='100%' cellpadding='5' border='0'>";
