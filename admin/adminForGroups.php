...
//GROUP 2 LISTING  ************************************************
// The file to be used as the database:
$databasefile = "../group2/data/coursescheduler";
...
?>
<br>
<form id="form2" name="form2" method="post" action="courseData.php">
<div style="float:right;font-size:.8em;"><a href="../group2/options.php">Group 2 Options Page</a><br/><a href="readCalendarfiles.php?group=2">Saved HTML Files</a></div>
<div class="style3">Display Course from Group 2 <span style="font-size:.8em;">(<?php echo $numcourses; ?> Courses)</span></div>
<select name="courseID">
...
<input type="submit" name="submit" value="GO" />
<br />
<div class="comment">Course can be deleted from displayed page.</div>
<a href="courseScheduleListing.php?group=2">Course Schedule Listing for Group 2</a>
</form>
...
//GROUP 3 LISTING
// The file to be used as the database:
$databasefile = "../group3/data/coursescheduler";
...
<br>
<form id="form2" name="form2" method="post" action="courseData.php">
<div style="float:right;font-size:.8em;"><a href="../group3/options.php">Group 3 Options Page</a><br/><a href="readCalendarfiles.php?group=3">Saved HTML Files</a></div>
<div class="style3">Display Course from Group 3 <span style="font-size:.8em;">(<?php echo $numcourses; ?> Courses)</span></div>
<select name="courseID">
...
<br />
<div class="comment">Course can be deleted from displayed page.</div>
<a href="courseScheduleListing.php?group=3">Course Schedule Listing for Group 3</a>
</form>
