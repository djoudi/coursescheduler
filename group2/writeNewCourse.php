...
//DON'T DUPLICATE IF COURSE CREATED BY ADMIN
	if($userID != "admin"){

//SHARE WITH ADMIN-LIST IN usercourses WITH userID as owner
	$query = $db_handle->exec("INSERT INTO usercourses (userID,courseID,owner)VALUES('admin','$courseID','$userID')");
	$db_handle=null;
	}
